...
use sherd_platform::{CapabilityLevel, CapabilityReport, LinkState, PlatformBackend};
use sherd_protocol::{AutoOutcome, Event, StatusReport};
...
/// translates [`sherd_protocol::Request`]s into calls on it.
...
impl SherdService {
    ...
    pub async fn capability(&self) -> sherd_platform::PlatformResult<CapabilityReport> {
    ...
    pub async fn hotspot_start(&self, ssid: &str, key: &str) -> sherd_platform::PlatformResult<()> {
    ...
    pub async fn hotspot_stop(&self) -> sherd_platform::PlatformResult<()> {
    ...
    pub async fn station_connect(&self, ssid: &str, key: &str) -> sherd_platform::PlatformResult<()> {
    ...
    pub async fn station_disconnect(&self) -> sherd_platform::PlatformResult<()> {
